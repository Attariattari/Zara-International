    ...
    <div className="navbarmain pb-2">
      ...
      <div className="secondsections">
        <div className="navlhs">
          ...
          <div>
            <NavLink to="/Help" activeClassName="active" className="helpbut">
              HELP
            </NavLink>
          </div>
        </div>
...
export default NavBar_Show_After_Cart;
...
//       <div className="firstsection">
//         <div className="sidebaricon cursor-pointer">
//           <svg
//             width="24"
//             height="24"
//             viewBox="0 0 24 24"
