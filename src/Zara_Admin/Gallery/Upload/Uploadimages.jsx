        ...
        <div className="Uploadimages-mainArea-data">
          <div className="Uploadimages-side">
            <div className="Uploadimages-side-title">
              <p>Folders.</p>
              <p onClick={createfolder}>Create Folder</p>
              {/* <div className={`UploadImages ${folder ? "show" : "hide"}`}>
               
              </div> */}
              {folder && <div className="UploadImages-popup">hello</div>}
            </div>
            <div className="Uploadimages-side-folder">
              <div>Muhyo Din</div>
              <div>Muhyo Din</div>
              <div>Muhyo Din</div>
              <div>Muhyo Din</div>
          ...
          <div className="Uploadimages-main">main</div>
        </div>
      </div>
    </div>
